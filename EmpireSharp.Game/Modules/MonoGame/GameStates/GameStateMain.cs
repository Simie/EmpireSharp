...
namespace EmpireSharp.Game.Modules.MonoGame.GameStates
{
	...
	public class GameStateMain
	{
		...
		public void Draw(float dt)
		{
			...
			game.SpriteBatch.DrawString(Content.DebugFont, string.Format("Terrain [TC: {0}, DC: {1}]", _terrainRenderer.TileBatch.TileCount, _terrainRenderer.TileBatch.DrawCallCount), new Vector2(300, 30), Color.White);
